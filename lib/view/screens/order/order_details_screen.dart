                ...
                ? Column(children: [
                    Expanded(
                      ...
                      child: Column(children: [
                        ...
                        InfoCard(
                          title:
                              parcel ? 'sender_details'.tr : 'store_details'.tr,
                          address: parcel
                          ...
                          image: parcel
                              ? ''
                              : '${Get.find<SplashController>().configModel!.baseUrls!.storeImageUrl}/${controllerOrderModel.storeLogo}',
                          name: parcel
                          ...
                          messageOnTap: () =>
                            ...
                            notificationBody: NotificationBody(
                              ...
                              vendorId: controllerOrderModel.storeId,
                            ),
                            user: User(
                        ...
                        InfoCard(
                          ...
                          latitude: parcel
                              ...
                              : controllerOrderModel.deliveryAddress!.latitude,
                          longitude: parcel
                              ? controllerOrderModel.receiverDetails!.longitude
                              : controllerOrderModel.deliveryAddress!.longitude,
                          showButton: controllerOrderModel.orderStatus !=
                                  'delivered' &&
                              controllerOrderModel.orderStatus != 'failed' &&
                                        ...
                                        children: [
                                            ...
                                            Row(children: [
                                              ClipOval(
                                                  child: CustomImage(
                                                image:
                                                    '${Get.find<SplashController>().configModel!.baseUrls!.parcelCategoryImageUrl}/${controllerOrderModel.parcelCategory!.image}',
                                                height: 35,
                                                width: 35,
                                                fit: BoxFit.cover,
                                              )),
                                        ...
                                        ? Column(
                                            ...
                                            children: [
                                                ...
                                                Center(
                                                  ...
                                                  child: CustomImage(
                                                    image:
                                                        '${Get.find<SplashController>().configModel!.baseUrls!.orderAttachmentUrl}/${controllerOrderModel.orderAttachment}',
                                                    width: 200,
                                                  ),
                                                )),
                                                const SizedBox(
                    ...
                    showBottomView
                        ? ((accepted! &&
                                    !parcel &&
                                    (!cod || restConfModel || selfDelivery)) ||
                                processing! ||
                                confirmed!)
                            ? Container(
                                padding: const EdgeInsets.all(
